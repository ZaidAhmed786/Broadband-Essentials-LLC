                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                                <div className="single-footer-widget">
                                    <div className="widget-head">
                                        <Link href="/">
                                            <h2 className="text-white">Broadband Essentials LLC</h2>
                                        </Link>
                                    </div>
                                    <div className="footer-content">
                                        <p>
                                        At Broadband Essentials LLC, we are dedicated to providing top-notch internet services to homes and businesses. Our mission is to deliver fast, reliable, and affordable connectivity, ensuring you stay connected with the world seamlessly.
                                        </p>
                                        <p>
                                    ...
                                    <div className="footer-content">
                                        <ul className="contact-info">
                                            ...
                                            <li className="d-flex ">
                                                ...
                                                <Link href="mailto:sales@broadbandessentials.net ">sales@broadbandessentials.net </Link>
                                            </li>
                                            <li className="d-flex ">
                    ...
                    <div className="container">
                        <div className="footer-wrapper d-flex align-items-center justify-content-center mt-5 pt-4">
                            <p className="wow fadeInLeft color-2" data-wow-delay=".3s">
                                © All Copyright {new Date().getFullYear()}  |   Broadband   <Link href="/">Essentials LLC</Link>
                            </p>
