                                            ...
                                            <div className="contact-info-area-2">
                                                <div className="contact-info-items mb-4">
                                                    ...
                                                    <div className="content">
                                                        ...
                                                        <div >
                                                            <a href="tel:+18888688345" className="text-white fs-6 fw-bold">+1 (888) 868-8345</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="contact-info-items mb-4">
                                                    ...
                                                    <div className="content">
                                                        ...
                                                        <div >
                                                            <Link href="mailto:sales@cabledeal.live " className="text-white fs-6 fw-bold">sales@cabledeal.live </Link>
                                                        </div>
                                                    </div>
                                                </div>
